...
const ContactForm = () => {
  const EMAILJS_CONFIG = {
    service_id: "service_z66d3pe",
    template_id: "template_75m1cfj",
    public_key: "L4KiG_MtOqw6fwPNB"
  }
      ...
      >
        {({
          ...
          <form onSubmit={handleSubmit} id="cform" action={"/"}>
            ...
            <div className="form-status alert-success" id="contactFormStatus" style={{
