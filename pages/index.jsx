            ...
            <div className="section hero-started">
              ...
              >
                ...
                <div className="description">
                  <div>
                    <p>
                      Based in Denver, Colorado, I have rich experience in designing and developing modern websites,
                  ...
                  <div className="social-links"> 
                    ...
                    <a target="_blank" rel="nofollow" href="https://www.linkedin.com/in/martinstojmenovski/">
                      <i aria-hidden="true" className="fab fa-linkedin-in" />
                    </a>
                    <a target="_blank" rel="nofollow" href="https://www.behance.net/martinstojmen">
              ...
              >
                <img
                  ...
                  alt="<b>Developer</b>Profile</b>Picture"
                />
            ...
            <SwiperSlide className="swiper-slide">
              <div className="services-item">
                ...
                <div className="lui-text">
                  <div>
                    {" "}
                    Full-Stack web applications built from the ground up. Front-end, back-end, database, deployment — the complete technical solution.{" "}
                  </div>
                </div>
            ...
            <SwiperSlide className="swiper-slide">
              <div className="services-item">
                ...
                <div className="lui-text">
                  <div>
                    {" "}
                    Strategic campaign creation, optimization,
                    and analysis to convert clicks into customers and
            ...
            <div className="skills-items">
              ...
              >
                ...
                <div className="text">
                  <div>
                    <p>
                      Core language for web development, powering both frontend interactivity and backend functionality.
                    </p>
                  </div>
                </div>
                <div className="dots">
              ...
              >
                ...
                <div className="text">
                  <div>
                    <p>
                      Develop reliable, scalable, and efficient backend services, APIs, and server-side logic for full-stack applications.
                    </p>
                  </div>
                </div>
                <div className="dots">
            ...
            <div className="skills-items">
              ...
              >
                ...
                <div className="text">
                  <div>
                    <p>
                      Create interactive, dynamic, and component-based user interfaces for responsive and highly scalable websites.
                    </p>
                  </div>
                </div>
                <div className="dots">
              ...
              >
                ...
                <div className="text">
                  <div>
                    <p>
                      Build modern, high-performance web applications with server-side rendering, routing, and scalable architecture.
                    </p>
                  </div>
                </div>
                <div className="dots">
            ...
            <div className="skills-items">
              ...
              >
                ...
                <div className="text">
                  <div>
                    <p>
                      Using AI tools to speed up development, debug issues, refactor code, and improve code quality across frontend and backend projects.
                    </p>
                  </div>
                </div>
                <div className="dots">
              ...
              >
                ...
                <div className="text">
                  <div>
                    <p>
                      Manage campaigns to drive traffic, increase conversions, and maximize return on ad spend (ROAS).
                    </p>
                  </div>
                </div>
                <div className="dots">
          ...
          <div className="col-xs-12 col-sm-12 col-md-5 col-lg-5">
            <div className="numbers-items">
              ...
              >
                ...
                <div className="lui-text">
                  <span> martinstojmenovskim@gmail.com </span>
                </div>
              </div>
              <div
                className="numbers-item scrolla-element-anim-1 scroll-animate"
